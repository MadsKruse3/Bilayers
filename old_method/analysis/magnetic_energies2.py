...
if __name__ == "__main__":
    ...
    np.savetxt('insulators_exfoliation_energy_new.npy', insulators_exfoliation)   
    np.savetxt('insulators_exchange_energy_new.npy', insulators_exchange)
    np.savetxt('metals_exfoliation_energy_new.npy', metals_exfoliation)   
    np.savetxt('metals_exchange_energy_new.npy', metals_exchange)
            

    #print(len(Ediffs))
    #print(len(name_energies))
    ...
    plt.savefig('Energy_diff_exfoliation_energy_scatterplot_colorcoded_new.png')
    ...
    plt.legend(['metals' ,'insulators'])
    plt.savefig('Energy_diff_exfoliation_energy_scatterplot_colorcoded_closeup_new.png')
    ...
    plt.legend(['metals' ,'insulators'])
    plt.savefig('Energy_diff_exfoliation_energy_scatterplot_metals_new.png')
    ...
    plt.legend(['metals' ,'insulators'])
    plt.savefig('Energy_diff_exfoliation_energy_scatterplot_insulators_new.png')
